...
class CustomResnet101_centercam_1net(torch.nn.Module):
    def __init__(self, num_classes=4): 
        super(CustomResnet101_centercam_1net, self).__init__()
    ...
    def forward(self, x): #input shape (batch_size, 6, 128, 128)
        ...
        x5 = self.resnet(inputs5)
        x6 = self.resnet(inputs6)
...
model = CustomResnet101_centercam_1net()
